...
export const MERCHANT_KEYWORDS: { kw: string; category: string }[] = [
  ...
  { kw: "קפה", category: "בילויים" },
  { kw: "מינימרקט", category: "מזון" },
  { kw: "שוק", category: "מזון" },
  { kw: "משק", category: "מזון" },
  { kw: "ניצת הדובדבן", category: "מזון" },
  { kw: "פרטנר", category: "חשבונות" },
  { kw: "סלקום", category: "חשבונות" },
  { kw: "הוט", category: "חשבונות" },
  { kw: "בזק", category: "חשבונות" },
  { kw: "yes", category: "חשבונות" },
  { kw: "פנגו", category: "תחבורה" },
  { kw: "pango", category: "תחבורה" },
  { kw: "רב קו", category: "תחבורה" },
  { kw: "רכבת", category: "תחבורה" },
  { kw: "ביטוח", category: "חשבונות" },
  { kw: "הפניקס", category: "חשבונות" },
  { kw: "מגדל", category: "חשבונות" },
  { kw: "הראל", category: "חשבונות" },
  { kw: "כלל בריאות", category: "חשבונות" },
  { kw: "מנורה", category: "חשבונות" },
